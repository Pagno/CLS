...
(function()
{
    ...
    */
   YAHOO.extend(MyCompany.dashlet.HelloWorld, Alfresco.component.SearchBase,
   {
      /**
      ...
      onReady: function HelloWorld_onReady()
      {
         ...
         this.widgets.testButton = Alfresco.util.createYUIButton(this, "okbutton", this.onButtonClick);
      },
